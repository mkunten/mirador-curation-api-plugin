var _marked = /*#__PURE__*/_regeneratorRuntime().mark(fetchCurations),
...
import { PluginActionTypes, receiveCuration, receiveCurationFailure } from './actions';
import { getCurationsApiConfig, getCanvasIdsAndMap, getCurations } from './selectors';
...
function initCurationItems(json, _ref3) {
  var canvasIds = _ref3.canvasIds,
    map = _ref3.map;
  var curationItems = [];
  var curationId = json['@id'];
  var curationLabel = json.label || null;
  json.selections.forEach(function (s, idx0) {
    var common = {
    ...
    if (s.members) {
      s.members.forEach(function (m, idx1) {
        var canvasIdAndRegion = parseCanvasIdFragment(m['@id']);
        var index = canvasIds[common.manifestId].indexOf(canvasIdAndRegion.canvasId) + 1;
        curationItems.push(_extends({}, canvasIdAndRegion, {
      ...
      s.canvases.forEach(function (c, idx1) {
...
export function fetchCuration(_ref4) {
  var uri = _ref4.uri;
  return /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
    var canvasIdsAndMap, callbacks, dispatch;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return select(getCanvasIdsAndMap);
          case 2:
            canvasIdsAndMap = _context2.sent;
            callbacks = {
              failure: function failure(_ref5) {
                var error = _ref5.error;
                return receiveCurationFailure(uri, typeof error === 'object' ? String(error) : error, null);
              },
              success: function success(_ref6) {
                var json = _ref6.json;
                return receiveCuration(uri, json, initCurationItems(json, canvasIdsAndMap));
              }
            };
            _context2.next = 6;
            return call(fetchCurationResource, uri, {}, callbacks);
          case 6:
            dispatch = _context2.sent;
            _context2.next = 9;
            return put(dispatch);
          case 9:
          case "end":
...
export function fetchCurations() {
  var config, uris, curations, i, uri;
  return _regeneratorRuntime().wrap(function fetchCurations$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.next = 2;
          return select(getCurationsApiConfig);
        case 2:
        ...
        case 5:
          uris = config.curations;
          _context3.next = 8;
          return select(getCurations);
        case 8:
          curations = _context3.sent;
          i = 0;
        case 10:
          if (!(i < uris.length)) {
            _context3.next = 18;
...
export default function curationsSaga() {
  return _regeneratorRuntime().wrap(function curationsSaga$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _context4.next = 2;
          return all([takeEvery(ActionTypes.SET_CANVAS, fetchCurations), takeEvery(PluginActionTypes.REQUEST_CURATION, fetchCurations)]);
        case 2:
        case "end":
