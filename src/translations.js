const translations = {
  en: {
    curations: 'Curation List',
    curationResourceImport: 'Import an external curation resource',
    curationResourceImportError: 'input url',
    ...
    openCompanionWindow_curations: 'curation list',
    showingNumCurations: 'Showing {{number}} curations',
  },
};
